...
def reach_observation(data) -> np.ndarray:
    ...
    return np.concatenate(
        [
            data.qpos,
            data.qvel,
            end_effector[:2] - data.mocap_pos[0][:2],
            [branch_error_margin],
            [
                *open_branch_error,
                *folded_branch_error,
