...
def reach_observation(data, previous_action: np.ndarray | None = None) -> np.ndarray:
    ...
    return np.concatenate([base_observation, np.asarray(previous_action, dtype=np.float32)])
