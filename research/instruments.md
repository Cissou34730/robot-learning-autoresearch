...
separately from the policy/training recipe. Its published files are listed near
the active inquiry in `research/brief.md`, making reusable tools and outputs
