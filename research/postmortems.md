...
**Current synthesis:** Checkpoint-100352 remains the strongest available policy, with 772/800 successes (96.5%) across five disjoint research panels and 159/160 on the latest paired panel. This development result is below the 98% objective; the fixed task-reference result is reused evidence rather than independent confirmation. Both tested transfer interventions underperformed their unchanged parent, and the fresh replication produced only 57/160 and 80/160 on its measured checkpoints versus 159/160 for the parent.

**Lessons and limits:** Training proxies did not reliably rank task behavior. Experiment-3 diagnostics show repeated hold interruptions in weaker challengers, while parent failures also include episodes that never reached tolerance; the remaining failure mechanism is therefore not established. Fresh-training variance was high in the tested replication, and no tested intervention produced a stronger lineage. Research panels are development evidence rather than the official 200-episode assessment, so they cannot establish the objective-level result.

**Open questions:** Checkpoint-100352's result on the held-out official 200-episode panel and the cause of its remaining failures remain unresolved. No competing measured lineage currently provides evidence of a better policy.
