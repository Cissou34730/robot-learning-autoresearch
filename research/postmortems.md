...
## 840f1e05-cd5f-42ed-9505-50aafef87094 / Experiment 4

**Result:** The full-radius transfer did not improve the best-known policy. The existing experiment-2 `checkpoint-100352` lineage remains both working and best known; the experiment-4 candidates are not retained.

**Observed behavior:** Experiment 4 changed training target radii from 14-20 cm to the full official 6-20 cm range. The proxy peaked at 1.0 at `checkpoint-105472` and declined to 0.94 at `checkpoint-120832`. On the new disjoint 1,000-episode research panel, `checkpoint-105472`, `checkpoint-120832`, and the unchanged parent each achieved 965/1,000 successes (96.5%). Each candidate had one win and one loss in the two discordant paired episodes against the parent, so neither showed a task-success advantage.

**Hypothesis assessment:** The hypothesis is contradicted under this full-radius transfer recipe and training horizon: neither measured checkpoint exceeded the parent's 96.5% same-panel result or the best-known policy's prior 97.5% disjoint result. The evidence does not establish that radius coverage was ineffective in every training design, nor does the aggregate panel isolate inner- versus outer-radius effects.

**Interpretation:** Matching the parent on the new panel while reaching a higher training proxy confirms that the proxy cannot select a better task policy here. The full-radius intervention should not replace the unchanged recipe; restoring the best-known recipe preserves the only lineage with repeated near-objective development evidence. The 96.5% result remains development evidence, not an official verdict, so the campaign objective is unresolved.

**Evidence inspected:** `research/brief.md`; `research/research_state.json`; `research/results.jsonl`; `research/checkpoints/challengers/840f1e05-cd5f-42ed-9505-50aafef87094/experiment-4/inventory.json`; `research/evaluations/840f1e05-cd5f-42ed-9505-50aafef87094/evaluation-840f1e05-cd5f-42ed-9505-50aafef87094-experiment-4-checkpoint-105472-1000ep-seed4200-f48545f83637.json`; `research/evaluations/840f1e05-cd5f-42ed-9505-50aafef87094/evaluation-840f1e05-cd5f-42ed-9505-50aafef87094-experiment-4-checkpoint-120832-1000ep-seed4200-f48545f83637.json`; `research/evaluations/840f1e05-cd5f-42ed-9505-50aafef87094/evaluation-840f1e05-cd5f-42ed-9505-50aafef87094-experiment-4-best_known-1000ep-seed4200-f48545f83637.json`.
