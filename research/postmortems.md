...
**Current synthesis:** The baseline learned useful reach-and-hold behavior, but checkpoint-100352 remains below the human objective at 772/800 successes (96.5%) across five disjoint research panels. The broadened-coverage challengers reached 151/160 each versus 152/160 for their parent, the partial hold-progress forfeiture challengers reached 142/160 and 140/160 versus 158/160 for the parent, and the fresh replication reached only 57/160 and 80/160 versus 159/160 for the parent on the latest panel. The fixed task-reference result is reused development evidence, not independent confirmation. Checkpoint-100352 remains the strongest available policy.

**Lessons and limits:** Training proxies did not reliably rank task behavior, neither tested transfer intervention improved the paired result, and fresh-training variance in experiment 4 produced a much weaker policy rather than a useful alternative. Experiment-3 diagnostics show repeated hold interruptions in the weaker challengers, but parent failures also include episodes that never reached tolerance. The research panels are development evidence rather than the official 200-episode assessment, and unmeasured checkpoints remain unmeasured rather than failed.

**Open questions:** The cause of the remaining parent failures and checkpoint-100352's generalization to the held-out official panel remain unresolved; the measured fresh replication provides no useful competing lineage. The official benchmark remains the only source of an objective-level verdict.
...
## 5dd70b88-9f25-45f4-a3f7-ac764a7b7973 / Experiment 4

**Result:** The fresh baseline replication did not reproduce the useful baseline policy and supplied no stronger candidate for the human objective.

**Observed behavior:** On the new disjoint research panel at episodes 5000-5159, the replicated checkpoint-100352 achieved 57/160 successes (35.625%) and the replicated checkpoint-120832 achieved 80/160 (50.0%). The unchanged working lineage achieved 159/160 (99.375%) on the same panel. Paired comparisons gave the working lineage 102 discordant wins over checkpoint-100352 and 79 over checkpoint-120832; neither replicated checkpoint won a discordant episode. The experiment's training proxies rose late in the run, but this did not translate into task success.

**Hypothesis assessment:** The hypothesis is contradicted: fresh initialization did not reproduce or exceed the best-known checkpoint, and neither measured replicated checkpoint approached the expected 157/160 threshold. This establishes high variance for this fresh run under the unchanged recipe, not that every fresh seed will fail or that the unchanged method cannot improve under another training condition.

**Expected observation disposition:** contradicted - on the new disjoint panel, replicated checkpoints reached 57/160 and 80/160 versus 159/160 for the working lineage, with 102 and 79 parent wins respectively and no challenger wins.

**Interpretation:** Experiment 4 does not justify replacing the current working or best-known lineage, and its candidates have no demonstrated reuse value. Keep the unchanged scientific recipe and preserve checkpoint-100352 as the strongest available policy. The pooled disjoint development evidence for that policy is 772/800 (96.5%), still below the 98% objective; the official benchmark remains necessary for the objective-level verdict, while further training is a separate post-closure campaign decision.

**Evidence inspected:** research/brief.md; research/research_state.json; research/results.jsonl; research/checkpoints/challengers/5dd70b88-9f25-45f4-a3f7-ac764a7b7973/experiment-4/inventory.json; research/evaluations/5dd70b88-9f25-45f4-a3f7-ac764a7b7973/evaluation-5dd70b88-9f25-45f4-a3f7-ac764a7b7973-experiment-4-checkpoint-100352-160ep-seed5000-f48545f83637.json; research/evaluations/5dd70b88-9f25-45f4-a3f7-ac764a7b7973/evaluation-5dd70b88-9f25-45f4-a3f7-ac764a7b7973-experiment-4-checkpoint-120832-160ep-seed5000-f48545f83637.json; research/evaluations/5dd70b88-9f25-45f4-a3f7-ac764a7b7973/evaluation-5dd70b88-9f25-45f4-a3f7-ac764a7b7973-experiment-4-working-160ep-seed5000-f48545f83637.json
