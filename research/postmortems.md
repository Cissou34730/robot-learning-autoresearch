...
## Experiment 3
**Result:** Reducing the PPO learning rate from 0.0001 to 0.00005 did not improve reliability: the candidate peaked at 41.5% (83/200) at checkpoint-60416, then measured 27.5%, 36.0%, and 34.5%; the champion scored 48.0%.
**Observed behavior:** Candidate successes had similar rewards (about 103.3) but failures truncated at 500 steps with mean failure rewards from -4.0 to -5.0, compared with -0.93 for the champion.
**Interpretation:** Smaller updates did not prevent the late reliability loss, and the candidate also regressed on the task-reference panel (33.5% versus the champion's 48.5%); update disruption is therefore not supported as the primary mechanism.
**Evidence inspected:** research/evaluations/evaluation-experiment-3-checkpoint-60416-200ep-seed2000-31932e1eb9a8.json research/evaluations/evaluation-experiment-3-checkpoint-90112-200ep-seed2000-31932e1eb9a8.json research/evaluations/evaluation-experiment-3-checkpoint-110592-200ep-seed2000-31932e1eb9a8.json research/evaluations/evaluation-experiment-3-checkpoint-120832-200ep-seed2000-31932e1eb9a8.json research/evaluations/evaluation-experiment-3-champion-200ep-seed2000-31932e1eb9a8.json research/evaluations/task-reference-experiment-3-checkpoint-120832-task-reference-v1.json research/evaluations/task-reference-experiment-3-champion-task-reference-v1.json
