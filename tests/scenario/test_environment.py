...
def test_training_distribution_adds_focus_without_changing_evaluation():
    ...
    assert training.focused_target_probability == FOCUSED_TARGET_PROBABILITY
